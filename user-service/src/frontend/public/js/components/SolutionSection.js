    ...
    cards: [
      {
        ...
        title: 'Оценка взгляда',
        desc:  '3D-вектор взгляда с точностью до 2.5°. ResNet-backbone, обученный на 80 000+ примерах.',
      },
      {
        ...
        desc:  'cv2.solvePnP определяет наклон и поворот головы в реальном времени. Учитывает движение, не только взгляд.',
      },
      {
