        ...
        <div class="integration-grid">
          ...
          <div class="intg-card reveal reveal-d1">
            ...
            <div class="intg-actions">
              <a href="/FOCUS-Setup-win.zip" class="intg-btn intg-btn-primary" download>
            ...
            <!-- Установщики раздаются в zip: браузер не блокирует .zip так, как
                 «голый» .exe. После распаковки запустите установщик. -->
            <div class="intg-win-note">
              ...
              <div>
                <span>
                  Распакуйте архив и запустите установщик. На Windows может появиться
                  предупреждение SmartScreen — приложение пока без цифровой подписи,
