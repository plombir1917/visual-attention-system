      ...
      <div class="section-wrap">
        ...
        <div class="section-header-center reveal">
          ...
          <p style="margin-top:16px;font-size:17px;color:#64748b;line-height:1.7">
            Два способа начать — выберите подходящий для вас.
          </p>
        </div>
        ...
        <div class="integration-grid">
          ...
          <div class="intg-card reveal reveal-d1">
            ...
            <!-- Пример использования: скриншот запущенного приложения.
                 Положите файл desktop-preview.png в каталог public/.
                 Если файла нет — фигура скрывается, чтобы не показывать битую картинку. -->
            <figure class="intg-shot">
              <figcaption class="intg-shot-label">Пример использования</figcaption>
              <img
                src="desktop-preview.png"
                alt="Десктопный клиент ФОКУС во время сессии"
                loading="lazy"
                @error="$event.target.closest('.intg-shot').style.display='none'"
              />
            </figure>
            ...
            <div class="intg-actions">
              <div class="intg-dl">
                <a href="/FOCUS-Setup-win.zip" class="intg-btn intg-btn-primary" download aria-describedby="win-smartscreen-tip">
                  ...
                  Windows
                  <span class="intg-btn-sub">.zip</span>
                </a>
                <!-- Подсказка про SmartScreen — только при наведении/фокусе на Windows-кнопку. -->
                <div id="win-smartscreen-tip" class="intg-win-tip" role="tooltip">
                  ...
                  <span>
                    На Windows может появиться предупреждение SmartScreen — приложение пока
                    без цифровой подписи, это нормально: нажмите
                    <b>«Подробнее» → «Выполнить в&nbsp;любом&nbsp;случае»</b>.
                  </span>
                </div>
              </div>
              <a href="/FOCUS-linux.zip" class="intg-btn intg-btn-primary" download>
